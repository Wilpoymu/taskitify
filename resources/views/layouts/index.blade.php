...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!-- ===============================================--><!--    Document Title--><!-- ===============================================-->
    <title>Taskitify | Landing Page</title>
    ...
    <!-- ===============================================--><!--    Stylesheets--><!-- ===============================================-->
    <link rel="stylesheet" href="{{asset('libs/landing/vendors/swiper/swiper-bundle.min.css')}}">
    ...
    <link href="{{asset('libs/landing/assets/css/theme.min.css')}}" rel="stylesheet" id="style-default">
    <link href="{{asset('libs/langing/assets/css/user-rtl.min.css')}}" rel="stylesheet" id="user-style-rtl">
    <link href="{{asset('libs/landing/assets/css/user.min.css')}}" rel="stylesheet" id="user-style-default">
  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="content">
        <nav class="navbar navbar-expand-md fixed-top" id="navbar" data-navbar-soft-on-scroll="data-navbar-soft-on-scroll">
          <div class="container-fluid px-0"><a href="/"><img class="navbar-brand w-75 d-md-none" src="{{asset('libs/landing/assets/img/logos/logo.svg')}}" alt="logo" /></a><a class="navbar-brand fw-bold d-none d-md-block" href="/">Taskitify</a><a class="btn btn-primary btn-sm ms-md-x1 mt-lg-0 order-md-1 ms-auto" href="/register">Get Started Now </a><button class="navbar-toggler border-0 pe-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-content" aria-controls="navbar-content" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        ...
        <div data-bs-target="#navbar" data-bs-spy="scroll" tabindex="0">
              ...
              <div class="container">
                <div class="row gy-4 gy-md-8 pt-9 pt-lg-0">
                  <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <div class="d-flex flex-wrap justify-content-center justify-content-lg-start gap-2 position-relative z-2"><a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="libs/landing/assets/img/logos/App_Store.webp" alt="assets/img/logos/App_Store.webp" /></a><a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="libs/landing/assets/img/logos/Play_Store.webp" alt="assets/img/logos/Play_Store.webp" /></a></div>
                  </div>
                  <div class="col-lg-6 position-lg-relative">
                    <div class="position-lg-absolute z-1 text-center"><img class="img-fluid chat-image" src="libs/landing/assets/img/Hero/Frame.webp" alt="" />
                      <div class="position-absolute dots d-none d-md-block"> <img class="img-fluid w-50 w-lg-75" src="libs/landing/assets/img/illustrations/Dots.webp" alt="" /></div>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div class="position-absolute bottom-0 start-0 end-0 z-1"><img class="wave mb-md-n2" src="libs/landing/assets/img/illustrations/Wave.svg" alt="" />
          ...
          <section class="container mb-8 mb-lg-13" id="about">
            <div class="row align-items-center">
              <div class="col-12 col-lg-6 col-xl-7"><img class="img-fluid" src="libs/landing/assets/img/Hero/Team.webp" alt="" /></div>
          ...
          <section class="container mb-8 mb-lg-13">
            <div class="row align-items-center">
              <div class="col-12 col-lg-6 col-xl-5 order-lg-1"><img class="img-fluid" src="libs/landing/assets/img/Hero/Collaborator.webp" alt="" /></div>
          ...
          <section class="experience position-relative overflow-hidden" id="service">
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-12">
                  <div class="position-relative z-1 text-center mb-8 mb-lg-9 video-player-paused" data-video-player-container="data-video-player-container"><video class="w-100 h-100 rounded-4" src="libs/landing/assets/video/Tech_video.mp4" poster="assets/img/Hero/experiences.webp" type="video/mp4" data-video-player="data-video-player"></video>
                    <div class="overlay position-absolute top-0 bottom-0 start-0 end-0 rounded-4 bg-1100 object-cover" data-overlay="data-overlay"> </div><button class="btn play-button position-absolute justify-content-center align-items-center bg-white rounded-circle cursor-pointer" data-play-button="data-play-button"> <img class="play-icon w-25" src="libs/landing/assets/img/illustrations/play-solid.svg" alt="" data-play-icon="data-play-icon" /><img class="pause-icon w-25" src="libs/landing/assets/img/illustrations/pause-solid.svg" alt="" data-pause-icon="data-pause-icon" /></button>
                    <div class="position-absolute dots d-none d-sm-block"><img class="img-fluid w-100" src="libs/landing/assets/img/illustrations/Dots.webp" alt="" /></div>
                  </div>
                </div>
                <div class="col-md-8 col-lg-7">
                ...
                <div class="col-12">
                  <div class="row gy-4 g-md-3 pb-8 pb-lg-11 px-1">
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="libs/landing/assets/img/icons/roadmap.svg" alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="libs/landing/assets/img/icons/users-wm.svg" alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="libs/landing/assets/img/icons/share-91.svg" alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="libs/landing/assets/img/icons/video_meeting.svg" alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="libs/landing/assets/img/icons/opening-times.svg" alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src="libs/landing/assets/img/icons/card-favorite.svg" alt="" />
                      <div>
            ...
            <div class="position-absolute top-0 start-0 end-0">
              <div class="bg-white py-3 py-md-9 py-xl-10"> </div><img class="wave" src="libs/landing/assets/img/illustrations/Wave_2.svg" alt="" />
            </div>
          </section>
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-1">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="libs/landing/assets/img/feedback/reviewer_1.webp" alt="" /></div>
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-2">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="libs/landing/assets/img/feedback/reviewer_2.webp" alt="" /></div>
                                <div class="text-center text-lg-start">
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-3">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="libs/landing/assets/img/feedback/reviewer_3.webp" alt="" /></div>
                                <div class="text-center text-lg-start">
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-4">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="libs/landing/assets/img/feedback/kakashi.webp" alt="" /></div>
                                <div class="text-center text-lg-start">
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-5">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src="libs/landing/assets/img/feedback/obito.webp" alt="" /></div>
                                <div class="text-center text-lg-start">
                ...
                <div class="col-lg-6">
                  <div class="accordion mt-lg-4 ps-3 pe-x1 bg-white" id="accordion">
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="heading1"><button class="accordion-button fs-8 lh-lg fw-bold pt-x1 pb-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expand="true" aria-controls="collapse1" data-accordion-button="data-accordion-button">How to setup Taskitify?</button></h2>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="heading2"><button class="accordion-button fs-8 lh-lg fw-bold pt-x1 pb-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expand="false" aria-controls="collapse2" data-accordion-button="data-accordion-button">Can I use Taskitify for my clients?</button></h2>
                    ...
                    <div class="accordion-item">
                      ...
                      <div class="accordion-collapse collapse" id="collapse5" data-bs-parent="#accordion">
                        <div class="accordion-body lh-xl pt-0 pb-x1">To reach our support team, simply send an email to support@Taskitify.com. Our team will promptly address your inquiry and provide assistance as needed.</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <section class="bg-300 position-relative z-0" id="contact">
            ...
            <div class="position-absolute bottom-0 end-0 z-n1 d-none d-lg-block"><img src="libs/landing/assets/img/illustrations/Green_dots.svg" alt="" /></div>
            <div class="position-relative bottom-0 start-0 z-1"><img class="img-fluid w-100" src="libs/landing/assets/img/illustrations/Wave_3.svg" alt="" /></div>
          </section>
            ...
            <div class="row gy-4 g-md-3 border-bottom pb-8 pb-lg-9 justify-content-center">
              ...
              <div class="col-6 col-md-3 d-md-flex flex-column align-items-md-end pe-md-0">
                <div>
                  ...
                  <div class="mb-1 mb-lg-2"> <a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="libs/landing/assets/img/logos/App_Store.webp" alt="assets/img/logos/App_Store.webp" /></a></div><a class="border-0 p-0 bg-transparent cursor-pointer rounded-1" href="#!"> <img class="img-fluid" src="libs/landing/assets/img/logos/Play_Store.webp" alt="assets/img/logos/Play_Store.webp" /></a>
                </div>
              </div>
            </div>
            <div class="row gy-2 py-3 justify-content-center justify-content-md-between">
              <div class="col-auto ps-0">
                <p class="text-center text-md-start lh-xl text-1100"> © 2024 Copyright, All Right Reserved, Made by <a class="fw-semi-bold" href="/">Taskitify Team</a>❤️</p>
              </div>
    ...
    <!-- ===============================================--><!--    JavaScripts--><!-- ===============================================-->
    <script src="{{asset('libs/landing/vendors/popper/popper.min.js')}}"></script>
    <script src="{{asset('libs/landing/vendors/bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{asset('libs/landing/vendors/is/is.min.js')}}"></script>
    <script src="{{asset('libs/landing/vendors/countup/countUp.umd.js')}}"></script>
    <script src="{{asset('libs/landing/vendors/swiper/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('libs/landing/vendors/lodash/lodash.min.js')}}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{asset('libs/landing/assets/js/theme.js')}}"></script>
  </body>
